local autolootaction = Action()


function autolootaction.onUse(player, item, fromPosition, target, toPosition, isHotkey)
local issue = {}
...
autolootaction:aid(500)
autolootaction:register()
