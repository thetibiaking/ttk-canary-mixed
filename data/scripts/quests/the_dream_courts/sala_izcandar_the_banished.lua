...
local config = {
	requiredLevel = 150,
	daily = true,
	roomCenterPosition = Position(1583, 1078, 7),
	playerPositions = {
		Position(1586, 1004, 7),
		Position(1586, 1005, 7),
		Position(1586, 1006, 7),
		Position(1586, 1007, 7),
		Position(1586, 1008, 7),
	},
	teleportPosition = Position(1582, 1072, 7),
	bossPosition = Position(1581, 1084, 7)
}
	...
	if item.itemid == 9825 then		
		...
		for i = 1, #config.playerPositions do
			...
			if participant and participant:isPlayer() then
				...
				if  config.daily and participant:getStorageValue(Storage.Boos.IzcandarTheBanished) > os.time() then
		...
		for i = 1, #team do
			...
			-- Assign boss timer
			team[i]:setStorageValue(Storage.Boos.IzcandarTheBanished, os.time() + 20*60*60) -- 20 hours
		end
