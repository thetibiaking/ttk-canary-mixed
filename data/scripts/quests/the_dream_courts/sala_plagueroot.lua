...
local config = {
	requiredLevel = 150,
	daily = true,
	roomCenterPosition = Position(1231, 1075, 7),
	playerPositions = {
		Position(1239, 1003, 7),
		Position(1239, 1004, 7),
		Position(1239, 1005, 7),
		Position(1239, 1006, 7),
		Position(1239, 1007, 7),
	},
	teleportPosition = Position(1235, 1080, 7),
	bossPosition = Position(1231, 1069, 7)
}
...
function leverboss.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 then		
		...
		-- Spawn boss
		Game.createMonster("Plagueroot", config.bossPosition)
		Game.createMonster("Plant Attendant", config.bossPosition)
		Game.createMonster("Plant Attendant", config.bossPosition)
