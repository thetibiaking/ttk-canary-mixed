...
local config = {
	...
	[39093]	= {NAME = 'White Lion', ID = 174, BREAK = true,	TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { {1, 'The White Lion got scared and ran away.'}, {3, 'The White Lion is trying to nibble.'} }, SUCCESS_MSG = 'You tamed a White Lion.', ACHIEV = "Well Roared, Lion!"}
