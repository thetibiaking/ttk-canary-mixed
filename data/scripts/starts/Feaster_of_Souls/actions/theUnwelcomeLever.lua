...
local config = {
	...
	requiredlevel = 150,
	centerPosition = Position(33709, 31539, 14),
	roomPlayerPosition = Position(33702, 31543, 14),
	bossPosition = Position(33709, 31533, 14),
	kickPosition = Position(33743, 31539, 14),
	storage = Storage.Boos.TheUnwelcome,
	range = {x = 15, y = 15},
	leverPositions = {
