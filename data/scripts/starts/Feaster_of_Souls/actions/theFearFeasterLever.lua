...
local config = {
	...
	requiredlevel = 150,
	centerPosition = Position(33711, 31469, 14),
	roomPlayerPosition = Position(33706, 31473, 14),
	bossPosition = Position(33712, 31464, 14),
	kickPosition = Position(33740, 31473, 14),
	storage = Storage.Boos.TheFearFeaster,
	range = {x = 15, y = 15},
	leverPositions = {
