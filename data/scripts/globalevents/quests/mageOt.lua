local config = {
    monsterName = 'Mage Ot',
    bossPosition = Position(1182, 1022, 7),
    centerPosition = Position(1182, 1022, 7),
    rangeX = 4,
    rangeY = 4
}
...
local mageOt = GlobalEvent("mageOt")
function mageOt.onThink(interval, lastExecution)
