...
monster.loot = {
	...
	{name = "magma boots", chance = 7500},
	{name = "blue gem", chance = 1560},
	{name = "giant sword", chance = 13500},
	{name = "war axe", chance = 2500},
	{name = "mercenary sword", chance = 2500},
	{name = "green crystal fragment", chance = 2500},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -750, maxDamage = -1300, radius = 4, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -800, maxDamage = -1350, length = 8, effect = CONST_ME_EXPLOSIONHIT, target = false}
