...
monster.loot = {
	...
	{name = "heavy mace", chance = 1400},
	{name = "war axe", chance = 1400},
	{name = "golden armor", chance = 1550},
	{name = "golden legs", chance = 1500},
	{name = "knight armor", chance = 4990},
	{name = "mastermind shield", chance = 2800},
	{id = 2578, chance = 280},
	...
	{name = "skullcracker armor", chance = 900},
	{name = "gold ingot", chance = 7692, maxCount = 2}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -870},
