...
monster.description = "a Murmillion"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -70, maxDamage = -480, range = 7, shootEffect = CONST_ANI_POISON, target = false},
