...
monster.loot = {
	...
	{name = "Gnome Shield", chance = 600},
	{name = "Gnome Sword", chance = 600},
	{name = "Mallet Handle", chance = 1000},
	{name = "Tinged Pot", chance = 2000},
	{name = "Gnome Helmet", chance = 200}
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 400, maxDamage = -1500, range = 3, length = 9, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 400, maxDamage = -1500, range = 3, length = 9, spread = 4, effect = CONST_ME_SMALLCLOUDS, target = false},
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = 400, maxDamage = -1500, radius = 8, effect = CONST_ME_BLACKSMOKE, target = false}
}
