...
monster.loot = {
	...
	{id = 30884, chance = 200},
	{id = 30885, chance = 600},
	{id = 25377, chance = 4520, maxCount = 8},
	{id = 30761, chance = 520},
	{id = 30883, chance = 500}
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 400, maxDamage = -1500, range = 3, length = 6, spread = 8, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = 400, maxDamage = -1500, range = 3, length = 9, spread = 4, effect = CONST_ME_HITBYFIRE, target = false},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = 400, maxDamage = -1500, radius = 2, effect = CONST_ME_EXPLOSIONAREA, target = false},
