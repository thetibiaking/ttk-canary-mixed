...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -362},
	{name ="practise fire wave", interval = 2000, chance = 20, minDamage = -100, maxDamage = -400, target = false},	
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -100, maxDamage = -300, length = 10, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false},
