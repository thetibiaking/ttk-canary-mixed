...
monster.loot = {
	...
	{name = "Lion Spangenhelm", chance = 10},
	...
	{name = "Lion Longbow", chance = 10},
	{name = "Lion Spellbook", chance = 10},
	{name = "Lion Wand", chance = 10},
	{name = "Lion Amulet", chance = 10},
	{name = "Lion Rod", chance = 10}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 500, maxDamage = -950, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 6000, chance = 40, type = COMBAT_HOLYDAMAGE, minDamage = -500, maxDamage = -900, length = 8, spread = 3, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 2750, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -900, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2500, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -900, radius = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 3300, chance = 40, type = COMBAT_ICEDAMAGE, minDamage = -500, maxDamage = -900, length = 4, spread = 0, effect = CONST_ME_ICEATTACK, target = false},
	{name ="combat", interval = 3000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -900, radius = 4, effect = CONST_ME_BIGCLOUDS, target = false}
}
