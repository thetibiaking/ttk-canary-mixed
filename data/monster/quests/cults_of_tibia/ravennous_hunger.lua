...
monster.loot = {
	...
	{name = "cobra crown", chance = 1000},
	{name = "silver token", chance = 2500},
	{name = "elven mail", chance = 500}
}
-- ALTERADO CHANCE DE 15 PARA 30. 
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -900, maxDamage = -1500},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_LIFEDRAIN, minDamage = -400, maxDamage = -700, range = 1, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 1500, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -480, maxDamage = -850, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -660, maxDamage = -1200, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false}
}
