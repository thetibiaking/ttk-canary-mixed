...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -300, maxDamage = -600, radius = 3, shootEffect = CONST_ANI_ENVENOMEDARROW, target = true},
	...
	{name ="combat", interval = 1500, chance = 35, type = COMBAT_DEATHDAMAGE, minDamage = -300, maxDamage = -750, radius = 4, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 1500, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -300, maxDamage = -750, radius = 4, effect = CONST_ME_ENERGYAREA, target = false}
}
