...
monster.health = 252000
monster.maxHealth = 252000
monster.race = "fire"
monster.corpse = 6068
monster.speed = 480
monster.manaCost = 0
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 390, attack = -1000},
	{name ="omrafir wave", interval = 2000, chance = 17, minDamage = -500, maxDamage = -1000, target = false},
	{name ="omrafir beam", interval = 2000, chance = 15, minDamage = -500, maxDamage = -3000, target = false},
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -1000, maxDamage = -3000, radius = 3, effect = CONST_ME_MAGIC_RED, target = false},
...
monster.defenses = {
	...
	{name ="omrafir healing 2", interval = 5000, chance = 10, target = false}
}
