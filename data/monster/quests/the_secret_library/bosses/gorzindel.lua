...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 30, minDamage = -600, maxDamage = -1800},	
	...
	{name ="combat", interval = 1000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -600, radius = 9, effect = CONST_ME_MAGIC_RED, target = false}
}
