...
monster.loot = {
	...
	{name = "medal of valiance", chance = 200},
	{name = "terra helmet", chance = 100},
	{name = "final judgement", chance = 10}
}
-- ALTEREI VALOR DE MELLE DE 200 E 600 PARA 500 E 900, RESPECTIVAMENTE.
-- ALTEREI VALOR DE MANADRAIN CHANCE DE 50 PRA 70
-- ALTEREI VALOR DE PHYSICALDAMAGE 400 E 1000 PARA 600 E 1100 RESPECTIVAMENTE.
-- ALTEREI VALOR DE FIREDAMAGE 300 E 500 PARA 450 E 800 RESPECTIVAMENTE. CHANCE ALTERADA DE 15 PARA 30.
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -500, maxDamage = -900},
	{name ="combat", interval = 2000, chance = 70, type = COMBAT_MANADRAIN, minDamage = -400, maxDamage = -1000, length = 7, spread = 3, effect = CONST_ME_SMALLCLOUDS, target = false},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -600, maxDamage = -1100, length = 7, spread = 3, effect = CONST_ME_YELLOW_ENERGY_SPARK, target = false},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -450, maxDamage = -800, length = 7, spread = 3, effect = CONST_ME_HITBYFIRE, target = false}
}
-- ALTERADA CHANCE HEALING DE 14 PARA 30. MINDAMAGE 150 PARA 250 E MAXDAMAGE 350 PARA 450.
monster.defenses = {
	defense = 25,
	armor = 78,
