...
-- ALTERADO MANADRAIN 3OO E 500 PARA 450 E 650.
-- ALTERADO PHISICODAMAGE 400 E 1200 PARA 500 E 1300.
monster.attacks = {
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_MANADRAIN, minDamage = -450, maxDamage = -600, radius = 5, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 1800, chance = 89, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -1300, length = 7, spread = 3, target = false}
}
