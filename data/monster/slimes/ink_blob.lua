...
monster.loot = {
	...
	{name = "Terra Boots", chance = 2850, maxCount = 4},
	{name = "Terra Hood", chance = 1980, maxCount = 4},
	{name = "Protection Amulet", chance = 2200, maxCount = 4},
	{name = "Sacred Tree Amulet", chance = 2200, maxCount = 4},
	{name = "Springsprout Rod", chance = 790, maxCount = 4},
	{name = "Stone Skin Amulet", chance = 1200, maxCount = 4},
	{name = "Terra Legs", chance = 4650, maxCount = 4},
	{name = "Terra Mantle", chance = 4550, maxCount = 4},
	{name = "Clay Lump", chance = 1200, maxCount = 4},
	{name = "Terra Amulet", chance = 6200, maxCount = 4}
}
