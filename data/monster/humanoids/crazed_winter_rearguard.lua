...
monster.loot = {
	...
	{name = "small enchanted sapphire", chance = 8850, maxCount = 7},
	...
	{name = "blue gem", chance = 1200}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -100, maxDamage = -400},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -50, maxDamage = -200, radius = 3, effect = CONST_ME_ICEAREA, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -50, maxDamage = -200, range = 7, shootEffect = CONST_ANI_ICE, target = false}
}
