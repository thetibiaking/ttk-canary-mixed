...
monster.loot = {
	...
	{name = "magma amulet", chance = 2655},
	{name = "wand of dragonbreath", chance = 15150},
	{name = "wand of draconia", chance = 1263},
	{name = "magma boots", chance = 8100},
	{name = "sun fruit", chance = 1800},
	{name = "bullseye potion", chance = 800}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -60, maxDamage = -430},
	{name ="combat", interval = 3000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -400, length = 3, spread = 0, effect = CONST_ME_FIREAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -050, maxDamage = -200, radius = 5, effect = CONST_ME_EXPLOSIONHIT, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -040, maxDamage = -200, radius = 5, effect = CONST_ME_EXPLOSIONAREA, target = true}
}
