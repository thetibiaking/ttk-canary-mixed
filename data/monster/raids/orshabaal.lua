...
monster.health = 82500
monster.maxHealth = 82500
monster.race = "fire"
monster.corpse = 5995
monster.speed = 380
monster.manaCost = 0
...
monster.loot = {
	...
	{name = "Orshabaal's brain", chance = 100000, maxCount = 1},
	{name = "thunder hammer", chance = 4000 , maxCount = 1},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -600, maxDamage = -2990},
	{name ="combat", interval = 1000, chance = 13, type = COMBAT_MANADRAIN, minDamage = -300, maxDamage = -1200, range = 7, target = false},
	...
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -310, maxDamage = -3600, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="firefield", interval = 1000, chance = 10, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -1850, length = 8, spread = 3, effect = CONST_ME_ENERGYHIT, target = false}
}
