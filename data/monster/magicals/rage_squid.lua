...
monster.loot = {
	...
	{name = "demonrage sword", chance = 2800},
	{id = 7393, chance = 390},
	{name = "giant sword", chance = 2850},
	{name = "demon shield", chance = 3950},
	{name = "magic plate armor", chance = 850},
	{name = "platinum amulet", chance = 350},
	{name = "wand of everblazing", chance = 300},
	{name = "fire axe", chance = 9200}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -300, maxDamage = -800},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -880, range = 7, shootEffect = CONST_ANI_FLAMMINGARROW, effect = CONST_ME_HITBYFIRE, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -680, range = 7, shootEffect = CONST_ANI_FIRE, target = false},
