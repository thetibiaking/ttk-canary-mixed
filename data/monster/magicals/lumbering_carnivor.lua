...
monster.loot = {
	...
	{name = "Glorious Axe", chance = 3100},
	{name = "Blue Robe", chance = 2600},
	{name = "Two Handed Sword", chance = 13000},
	{name = "Fur Armor", chance = 2400},
	{id = 7632, chance = 3200},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -100, maxDamage = -120, radius = 4, effect = CONST_ME_GROUNDSHAKER, target = false}
}
