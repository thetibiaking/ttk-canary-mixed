...
monster.loot = {
	...
	{name = "Guardian Shield", chance = 4000},
	{name = "Rainbow Quartz", chance = 5500},
	{name = "Blue Robe", chance = 3000},
	{name = "Glacier Amulet", chance = 3500},
	{name = "Lightning Pendant", chance = 1200},
	{name = "Prismatic Quartz", chance = 4500},
	{name = "Talon", chance = 2000},
	{name = "Terra Amulet", chance = 2500},
	{name = "Warrior Helmet", chance = 2000},
	{name = "Shockwave Amulet", chance = 1550},
	{name = "Terra Mantle", chance = 2050},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -130, maxDamage = -380, radius = 4, effect = CONST_ME_GROUNDSHAKER, target = false}
}
