...
monster.loot = {
	...
	{id = 7633, chance = 5560}, -- Giant shimmering pearl
	{name = "terra amulet", chance = 3000},
	{name = "giant sword", chance = 2500},
	{name = "war axe", chance = 1500},
	{name = "mercenary sword", chance = 2500},
	{name = "titan axe", chance = 2500},
	{name = "underworld rod", chance = 5500},
	{name = "sacred tree amulet", chance = 5500},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -400, maxDamage = -900, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYAREA, target = true},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -1200, radius = 7, effect = CONST_ME_BIGPLANTS, target = false},
	{name ="root", interval = 40000, chance = 1, target = true}
