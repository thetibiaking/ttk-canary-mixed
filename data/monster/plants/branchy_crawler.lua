...
monster.loot = {
	...
	{name = "ultimate health potion", chance = 32120, maxCount = 9},
	{name = "gold ingot", chance = 6560},
	{name = "terra legs", chance = 2560},
	{name = "violet gem", chance = 6000},
	{id = 38817, chance = 960}, -- Crawler's essence
	{name = "green gem", chance = 4000},
	{name = "blue gem", chance = 4500},
	{name = "hammer of wrath", chance = 1300},
	{name = "ruthless axe", chance = 1500},
	{name = "nightmare blade", chance = 1500},
	{name = "twiceslicer", chance = 1100},
	{name = "crystal crossbow", chance = 2500},
	{name = "crystalline sword", chance = 2500}
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -800, range = 7, shootEffect = CONST_ANI_PIERCINGBOLT, effect = CONST_ME_GREEN_RINGS, target = true},
