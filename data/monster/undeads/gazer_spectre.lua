...
monster.loot = {
	...
	{name = "Wand of Inferno", chance = 2100},
	{id = 34722, chance = 800},
	{name = "Magma Coat", chance = 1200},
	{name = "Prismatic Quartz", chance = 1500},
	{name = "Small Enchanted Emerald", chance = 800},
	{name = "Onyx Chip", chance = 870},
	{name = "Hexagonal Ruby", chance = 900}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -0, maxDamage = -480},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_FIREDAMAGE, minDamage = -50, maxDamage = -350, range = 7, shootEffect = CONST_ANI_FIRE, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -50, maxDamage = -250, radius = 3, effect = CONST_ME_FIREATTACK, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -50, maxDamage = -330, length = 4, spread = 3, effect = CONST_ME_YELLOWENERGY, target = false}
}
