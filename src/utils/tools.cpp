...
double uniform_double_random()
{
	static std::uniform_real_distribution<double> uniformRand(0.00, 100.00);
...
std::string valueConvert(int64_t value) {
	if (value >= 1000000000) {
		return std::to_string(value / 1000000000) + " kkk";
	}

	if (value >= 1000000) {
		return std::to_string(value / 1000000) + " kk";
	}
