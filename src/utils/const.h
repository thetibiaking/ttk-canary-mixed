...
enum MagicEffectClasses : uint8_t {
	...
	CONST_ME_WATER_FLOATING_THRASH = 247, // Permanent
...
enum CreatureIcon_t {
	...
	CREATUREICON_INFLUENCED = 4,
	CREATUREICON_FIENDISH = 5
...
enum PartyHuntType : uint8_t {
	TYPE_CLEAR = 0,
	TYPE_CHANGE_MODE = 1,
	TYPE_CYCLOPEDIA_PRICE = 2
};
...
enum item_t : uint16_t {
	...
	ITEM_SLIVER = 41944,
	ITEM_EXALTED_CORE = 41945,
	ITEM_EXALTED_CHEST = 42396,
	
	ITEM_DIVINE_EMPOWERMENT_WOD = 40450,
};
...
static constexpr int32_t STORAGEVALUE_DAILYREWARD = 114898;
