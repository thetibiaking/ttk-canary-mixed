...
class Weapon : public Event
{
	public:
		...
		virtual int64_t getWeaponDamage(const Player* player, const Creature* target, const Item* item, bool maxDamage = false, uint16_t cleaveDamage = 0) const = 0;
		virtual int64_t getElementDamage(const Player* player, const Creature* target, const Item* item, uint16_t cleavePercent = 0) const = 0;
...
class WeaponMelee final : public Weapon
{
	public:
		...
		int64_t getWeaponDamage(const Player* player, const Creature* target, const Item* item, bool maxDamage = false, uint16_t cleavePercent = 0) const override;
		int64_t getElementDamage(const Player* player, const Creature* target, const Item* item, uint16_t cleavePercent = 0) const override;
...
class WeaponWand final : public Weapon
{
	public:
		...
		int64_t getWeaponDamage(const Player* player, const Creature* target, const Item* item, bool maxDamage = false, uint16_t cleavePercent = 0) const override;
		int64_t getElementDamage(const Player*, const Creature*, const Item*, uint16_t) const override { return 0; }
