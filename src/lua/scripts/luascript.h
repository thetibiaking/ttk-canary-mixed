...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaCreaturIsInfluenced(lua_State* L);
		static int luaCreaturIsFiendish(lua_State* L);
		...
		static int luaPlayerSetCustomVip(lua_State* L);
		...
		static int luaPlayerClearSpellCooldown(lua_State* L);

		static int luaPlayerOpenExaltedForge(lua_State* L);
		...
		static int luaItemTypeGetBedPartOf(lua_State* L);
		...
		static int luaItemTypeGetItemBuyValue(lua_State* L);
		static int luaItemTypeGetItemSellingValue(lua_State* L);

		static int luaItemTypeSetBuyValue(lua_State* L);
		static int luaItemTypeSetSellValue(lua_State* L);
		...
		static int luaPartyUpdatePartyHunting(lua_State* L);
